...
int main() {
  ...
  // Double_t eta_low = 2. + 50. / (5. - 2.) * iY;
  // Double_t eta_high = 2. + 50. / (5. - 2.) * (iY + 1);
  // Double_t p_low = 3000. + 50. / (100000. - 3000.) * iX;
  // Double_t p_high = 3000. + 50. / (100000. - 3000.) * (iX + 1);
